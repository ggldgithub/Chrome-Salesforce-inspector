...
### npm request to https://registry.npmjs.org/react failed, reason: connect ETIMEDOUT 104.16.25.34:443 resolve
1.首先查看下目前配置:npm config list 查看是否已经配置了
2.设置网络代理的命令如下(以自己的代理地址为准)：npm config set proxy="http://127.0.0.1:7890"
---------开了梯子(上)没开梯子(下)------------
